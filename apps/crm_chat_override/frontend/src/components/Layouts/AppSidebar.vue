<template>
  ...
  >
    ...
    <div class="m-2 flex flex-col gap-1">
      ...
      >
        <template #icon>
          <LucideBotMessageSquare class="h-4 w-4" />
        </template>
      </SidebarLink>
...
const steps = reactive([
  ...
  },
  {
    ...
    onClick: async () => {
      ...
      if (deal) {
        router.push({ name: 'Deal', params: { dealId: deal }, hash: '#tasks' })
      } else {
  ...
  },
  {
    ...
    onClick: async () => {
      ...
      if (deal) {
        router.push({ name: 'Deal', params: { dealId: deal }, hash: '#notes' })
      } else {
  ...
  },
  {
    ...
    onClick: async () => {
      ...
      if (deal) {
        router.push({ name: 'Deal', params: { dealId: deal }, hash: '#comments' })
      } else {
        router.push({ name: 'Leads' })
      }
    },
  },
  {
    ...
    onClick: async () => {
      ...
      if (deal) {
        router.push({ name: 'Deal', params: { dealId: deal }, hash: '#emails' })
      } else {
        router.push({ name: 'Leads' })
      }
    },
    ...
    onClick: async () => {
      ...
      currentStep.value = {
        ...
        onClick: async () => {
          ...
          let deal = await getFirstDeal()
          if (deal) {
            router.push({ name: 'Deal', params: { dealId: deal }, hash: '#activity' })
          } else {
            router.push({ name: 'Leads' })
          }
        },
